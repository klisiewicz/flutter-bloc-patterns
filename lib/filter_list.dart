...
/// 2. Load the data:
/// ```dart
/// filterListBloc = BlocProvider.of<ListBloc<Data, Filter>>(context)..loadItems(filter);
/// ```
...
export 'package:flutter_bloc_patterns/src/list/filter/filter_repository.dart';
